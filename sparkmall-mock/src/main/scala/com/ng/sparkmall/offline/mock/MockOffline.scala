...
import com.ng.sparkmall.common.bean.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.ng.sparkmall.common.util.ConfigurationUtil
import com.ng.sparkmall.mock.util.{RandomDate, RandomNumUtil, RandomOptions}
